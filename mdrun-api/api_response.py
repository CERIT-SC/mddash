...
class ApiResponse:
    ...
    def success(data: object = None, status: HTTPStatus | int | None = None) -> Response:
        ...
        Returns:
            Response: A Flask Response object containing the success response.
        """
        if status is None:
    ...
    def error(error: Exception | str, status: HTTPStatus | int | None = None) -> Response:
        """
        Return an error response with the given message and log the error.
        ...
        Returns:
            Response: A Flask Response object containing the error response.
        """
        exc_info = False
