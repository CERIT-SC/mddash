...
class DemoState:
    ...
    def __init__(self) -> None:
        """Initialize the demo state with empty experiments."""
    ...
    def create_experiment(self, exp_id: str, name: str, source_message: str, mdrepo_id: str | None = None) -> dict:
        ...
        experiment: dict[str, object] = {
            ...
            "mdrepo_id": mdrepo_id,
            "mdrepo_record_url": f"https://workflow-repo.test.du.cesnet.cz/datasets/uploads/{mdrepo_id}"
            if mdrepo_id
            else None,
            "notebook": notebook,
            "tuner_jobs": [],
