...
@tuner_bp.route('/<experiment_id>/tuner', methods=['GET'])
...
@tuner_bp.route('/experiment_id>/tuner/<tpr_name>', methods=['GET'])
...
@tuner_bp.route('/<experiment_id>/tuner/<tpr_name>', methods=['POST'])
...
@tuner_bp.route('/<experiment_id>/tuner/<tpr_name>', methods=['DELETE'])
