...
class TunerJob(db.Model):  # type: ignore
    ...
    def _modify_tpr_async(experiment_id: str, input_tpr_name: str, output_tpr_name: str, nsteps: int, 
        ...
        :param input_tpr_name: Name of the input TPR file
        :param output_tpr_name: Name of the output TPR file
        :param nsteps: Number of simulation steps
        :param on_success: Callback to call when TPR modification succeeds
        :param on_error: Callback to call when TPR modification fails
        '''
    ...
    def start(cls, experiment: Experiment, tpr_path: Path, nsteps: int = 25000) -> 'TunerJob':
        ...
        :param nsteps: Number of steps for tuning runs (default: 25000, which is 50 ps)
        :return: The created TunerJob instance (in pending state)
        '''
