...
def delete_experiment(experiment_id):
    for i, e in enumerate(demo_experiments):
        if e['id'] == experiment_id:
            del demo_experiments[i]
            break
