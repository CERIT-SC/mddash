...
const FileSelector = (props: FileSelectorProps) => {
  ...
  useEffect(() => {
    if (isSuccess && selectedPath && !selectedFile) {
      onFileSelected(null)
    }
  }, [isSuccess, selectedPath, selectedFile, onFileSelected])
  ...
  return (
    <div className={className}>
      ...
      <Select value={selectedFile?.url ?? SELECT_NONE} onValueChange={handleChange}>
        <SelectTrigger
          id={id}
