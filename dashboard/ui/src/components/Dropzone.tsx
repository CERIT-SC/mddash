...
import { useDropzone, type Accept, type DropEvent, type DropzoneOptions, type FileRejection } from "react-dropzone"
  ...
  return (
    <div className={cn("flex flex-col gap-4", className)}>
      <div
        {...getRootProps()}
        className={cn(
          "text-muted-foreground flex cursor-pointer flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed p-8 text-center transition-colors",
          isDragActive ? "border-primary bg-primary/10 text-primary" : "hover:border-primary hover:bg-primary/5"
        )}
      >
