...
import type { PCAAnalysis } from "@/util/analysis-types"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"
import { formatStatValue, Scatter2D, ScreePlot } from "@/components/charts"
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4">
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="border-border/60 flex min-h-0 flex-col rounded-lg border p-4">
          <div className="mb-3 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium">Explained variance</p>
              <p className="text-muted-foreground text-xs">Scree plot of principal component eigenvalues</p>
            </div>
