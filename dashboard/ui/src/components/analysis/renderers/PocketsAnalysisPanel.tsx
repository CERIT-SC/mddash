...
import type { PocketsAnalysis } from "@/util/analysis-types"
  ...
  return pockets.length ? (
    <div className="flex h-full min-h-0 flex-col gap-4">
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="border-border/60 flex min-h-[280px] flex-col rounded-lg border p-4">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-4">
            <div>
              <p className="text-sm font-medium">Pocket volume over time</p>
              <p className="text-muted-foreground text-xs">Frame-wise pocket volume (A^3)</p>
            </div>
            {pockets.length > 1 && (
        ...
        <div className="border-border/60 flex min-h-[280px] flex-col rounded-lg border p-4">
          <div className="mb-3 flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-xs">Top {barCategories.length} pockets by average volume</p>
            </div>
            <p className="text-muted-foreground text-xs">Total pockets: {pockets.length}</p>
          </div>
          <div className="min-h-[220px] flex-1">
