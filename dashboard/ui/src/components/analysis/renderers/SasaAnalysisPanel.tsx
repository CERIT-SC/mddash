...
import type { SolventAccessibleSurfaceAnalysis } from "@/util/analysis-types"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"
import { BarChart, buildTimeSeries, formatStatValue, LineChart } from "@/components/charts"
          ...
          <div className="mb-3 flex flex-wrap items-center justify-between gap-4">
            ...
            {residues.length > 1 && (
              <div className="flex items-center gap-2">
                <span className="text-muted-foreground text-xs">Residue</span>
        ...
        <div className="border-border/60 flex min-h-70 flex-col rounded-lg border p-4">
          <div className="mb-3 flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-xs">Average SASA per residue (top {barCategories.length})</p>
            </div>
            <p className="text-muted-foreground text-xs">Residues analyzed: {residues.length}</p>
          </div>
          <div className="min-h-55 flex-1">
