...
import type { RMSDPairwiseAnalysis } from "@/util/analysis-types"
    ...
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="border-border/70 rounded-md border p-3">
          <p className="text-muted-foreground/80 text-[11px] tracking-wide uppercase">Active interface</p>
          <p className="text-base font-semibold">{activeEntry?.name?.trim() || `Interaction ${safeIndex + 1}`}</p>
        </div>
        <div className="border-border/70 rounded-md border p-3">
          <p className="text-muted-foreground/80 text-[11px] tracking-wide uppercase">Frames captured</p>
          <p className="text-base font-semibold">{frameCount || "N/A"}</p>
        </div>
        <div className="border-border/70 rounded-md border p-3">
          <p className="text-muted-foreground/80 text-[11px] tracking-wide uppercase">Frame step</p>
          <p className="text-base font-semibold">{typeof data.step === "number" ? `${data.step}` : "N/A"}</p>
        </div>
        <div className="border-border/70 rounded-md border p-3">
          <p className="text-muted-foreground/80 text-[11px] tracking-wide uppercase">Matrix resolution</p>
