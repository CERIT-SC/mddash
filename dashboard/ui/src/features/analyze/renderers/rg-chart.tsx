...
import type { RadiusOfGyrationAnalysis } from "../analysis-types"
import { formatStatValue, LineChart, statToSeries, type StatSeriesResult } from "../charts"
...
const RgChart: FC<RgChartProps> = ({ data }) => {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-2">
      {statsList.length > 0 && (
        <div className="text-text-muted grid grid-cols-2 items-center justify-items-center gap-x-6 gap-y-1 text-xs">
